class StudyZoneDownloadModel_wo_log {
  bool? status;
  Data? data;

  StudyZoneDownloadModel_wo_log({this.status, this.data});

  StudyZoneDownloadModel_wo_log.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  int? currentPage;
  List<StudyZoneData>? studyZoneData;
  String? firstPageUrl;
  int? from;
  int? lastPage;
  String? lastPageUrl;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        studyZoneData!.add(new StudyZoneData.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.studyZoneData != null) {
      data['data'] = this.studyZoneData!.map((v) => v.toJson()).toList();
    }
