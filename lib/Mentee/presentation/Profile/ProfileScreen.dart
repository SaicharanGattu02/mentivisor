...
import 'package:mentivisor/Mentee/data/cubits/MenteeProfile/MenteeProfileCubit.dart';
import 'package:mentivisor/Mentee/data/cubits/MenteeProfile/MenteeProfileState.dart';
...
class _ProfileScreen1State extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<MenteeProfileCubit, MenteeProfileState>(
