...
class _CommentBottomSheetState extends State<CommentBottomSheet> {
  ...
  void _startReply(
    ...
    setState(() {
      ...
      _replyingToMsg = msg;
      _replyingToUserId =
          replyingToUserId; // Store the user ID of the person you're replying to
    });
  }
  ...
  void _send() {
    ...
    final payload = {
      ...
      if (_replyParentId != null) ...{
        ...
        "is_reply": 1,
        "hashuser":
            _replyingToUserId, // Pass the user ID of the person being replied to
      },
    };
...
class CommentBottomSheet1 extends StatefulWidget {
  final CommunityPosts communityPost;
  final ScrollController scrollController;

  const CommentBottomSheet1({
    super.key,
    required this.communityPost,
    required this.scrollController,
  });
  ...
  @override
  State<CommentBottomSheet1> createState() => _CommentBottomSheet1State();
}

class _CommentBottomSheet1State extends State<CommentBottomSheet1> {
  final TextEditingController _controller = TextEditingController();
