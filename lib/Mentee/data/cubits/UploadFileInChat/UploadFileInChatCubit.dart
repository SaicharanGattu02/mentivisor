...
class UploadFileInChatCubit extends Cubit<UploadFileInChatStates> {
  ...
  UploadFileInChatCubit(this.uploadFileInChatRepo) : super(UploadFileInChatInitial());

  Future<void> uploadFileInChat(Map<String, dynamic> data) async {
    emit(UploadFileInChatLoading());
    try {
      final UploadFileInChatModel? response =
      await uploadFileInChatRepo.uploadFileInChat(data);
